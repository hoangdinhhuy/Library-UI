            ...
            <div className="max-w-4xl mx-auto mb-8">
                <div className="glass-panel p-6 rounded-xl animate-fade-in text-center">
                    <p className="text-gray-300 text-sm mb-4">
                        Phân tích toàn bộ 2,980 sản phẩm bằng <strong>K-Means Clustering (5 cụm)</strong> dựa trên Giá · Rating · Popularity để tìm "Đại dương xanh".
                    </p>
                ...
                <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
                    ...
                    <div className="bg-cyan-900/20 border border-cyan-500/40 rounded-xl p-5">
                        ...
                        <p className="text-gray-300 text-sm">
                            Những sản phẩm có <strong>doanh số đáng kể</strong> nhưng <strong>rating rất thấp (&lt; 2.0)</strong> — thị trường đang có nhu cầu nhưng chưa được đáp ứng tốt.
                            Đây là cơ hội để người bán gia nhập với sản phẩm chất lượng cao hơn và chiếm thị phần.
                        </p>
                    </div>
